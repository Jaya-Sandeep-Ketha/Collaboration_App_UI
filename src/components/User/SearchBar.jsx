...
function SearchBar({ onSearch }) {
  ...
  const handleSearchClick = () => {
    onSearch(projectId, featureName);
  };

  return (
    <div className="backdrop-blur-sm bg-white/1 shadow-xl rounded-lg p-6 border border-white/20">
      <h1 className="text-2xl font-bold text-white mb-6">Search Employee</h1>
